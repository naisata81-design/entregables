...
async function calcularVacacionesDinamicamente(user) {
    ...
    for (let req of consumos) {
        ...
        for (let grant of grants) {
            // Un grant es válido si se otorgó antes o el mismo día de la solicitud Y no había caducado en ese entonces
            if (grant.date <= reqDate && grant.expires > reqDate && grant.remaining > 0) {
