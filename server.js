...
const ProjectSchema = new mongoose.Schema({
    ...
    assignedTools: [{ type: mongoose.Schema.Types.ObjectId, ref: 'InventoryItem' }],
    ...
    planificacionDiaria: [{
        ...
        vehiculosAsignados: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Vehicle' }],
        tareasDelDia: String,
...
const QuoteSchema = new mongoose.Schema({
    ...
    fecha: { type: Date, default: Date.now },
    clienteId: { type: mongoose.Schema.Types.ObjectId, ref: 'Site' },
    elaboradaPorId: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
