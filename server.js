...
app.get('/api/vehicles/:id/history-route', async (req, res) => {
    try {
        ...
        if (req.query.date) {
            ...
            // Si quieres la zona horaria de MX, podrías sumar 6 horas, pero trabajemos en UTC o usar el local time del sistema.
            // Para simplificar, construiremos las fechas basadas en el input.
